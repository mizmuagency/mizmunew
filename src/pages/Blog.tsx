              ...
              <Link to={`/blog/${blogPosts[0].id}`} className="block relative group">
                ...
                <div className="max-w-3xl">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <span className="text-sm px-3 py-1 bg-[#9333EA] text-white rounded-full">Featured</span>
                  </div>
              ...
              {blogPosts.slice(1).map((post) => (
                <Link key={post.id} to={`/blog/${post.id}`} className="group">
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <span className="text-sm px-3 py-1 bg-[#9333EA] text-white rounded-full">{post.category}</span>
                  </div>
